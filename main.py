...
class MainApp():
    ...
    def __init__(self):
        ...
        self.__house = HouseManager(lights_handler = self.__controller_lights, fan_handler = None, alarm_handler = self.__activate_alarm,motor_handler = self.__controller_garage)
        self.__receive_data()
